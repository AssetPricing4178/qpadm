...
```{r}
prefix = "C:/Users/Jonat/Desktop/QPADM/reich_data"  # Base file path for genotype data
my_f2_dir = "C:/Users/Jonat/Desktop/QPADM/fstats"  # Directory for f2-statistics
library(admixtools)
library(tidyverse)
```
